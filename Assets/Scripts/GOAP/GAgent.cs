...
{
    // Store our list of actions; list of things we can do.
    public List<GAction> actions = new List<GAction>();
    // Dictionary of subgoals; objective for this agent.
    public Dictionary<SubGoal, int> goals = new Dictionary<SubGoal, int>();
    // Our inventory; list of world resources available to this agent
    public GInventory inventory = new GInventory();
    // Our beliefs; agent specific states.
